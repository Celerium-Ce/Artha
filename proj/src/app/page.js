    ...
    <div className="bg-gray-900 text-center text-gray-200 p-8 space-y-8">
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
          <h3 className="text-2xl font-semibold text-[#4B7EFF]">Track Transactions</h3>
        ...
        {/* Feature 2 */}
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
          <h3 className="text-2xl font-semibold text-[#4B7EFF]">Set Budgets</h3>
          <p className="mt-4 text-gray-300">
        ...
        {/* Feature 3 */}
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
          <h3 className="text-2xl font-semibold text-[#4B7EFF]">Insights & Reports</h3>
          <p className="mt-4 text-gray-300">
