...
export default function GamificationPage() {
  return (
    <div>
      <h1 className="text-3xl font-semibold text-teal-400 opacity-90 mb-6 pt-6 text-center">Gamification</h1>
      ...
      <div className="p-6 bg-gray-800 text-gray-200 rounded-2xl shadow-lg max-w-4xl mx-auto">
        ...
        <div className="bg-gray-700 p-6 rounded-2xl shadow-lg mb-6 text-center">
          <h2 className="text-xl font-semibold text-teal-400 opacity-90 mb-2">Your Streak</h2>
        ...
        <div className="bg-gray-700 p-6 rounded-2xl shadow-lg mb-6">
          <h2 className="text-xl font-semibold text-teal-400 opacity-90">Your Points</h2>
          <p className="text-3xl font-bold mt-2 text-white">1,250</p>
        </div>

        {/* Badges Section */}
        <div className="bg-gray-700 p-6 rounded-2xl shadow-lg mb-6">
          <h2 className="text-xl font-semibold text-teal-400 opacity-90 mb-4">Your Badges</h2>
        ...
        <div className="bg-gray-700 p-6 rounded-2xl shadow-lg">
          <h2 className="text-xl font-semibold text-teal-400 opacity-90 mb-4">Leaderboard</h2>
